          ...
          return ListView(
            ...
            children: [
              ...
              ListTile(
                ...
                title: Text(langProvider.getText('edit_profile')),
              ...
              ListTile(
                ...
                title: Text(langProvider.getText('wishlist')),
                trailing: const Icon(Icons.arrow_forward_ios, size: 16),
                onTap: () {
                  Navigator.push(
                    context,
              ...
              ListTile(
                ...
                title: Text(langProvider.getText('saved_addresses')),
                trailing: const Icon(Icons.arrow_forward_ios, size: 16),
                onTap: () {
                  Navigator.push(
                    context,
              ...
              ListTile(
                ...
                title: Text(langProvider.getText('notifications')),
                trailing: const Icon(Icons.arrow_forward_ios, size: 16),
                onTap: () {
                  Navigator.push(
                    context,
              ...
              Consumer<ThemeProvider>(
                builder: (context, themeProvider, child) {
                  return SwitchListTile(
                    ...
                    title: Text(langProvider.getText('dark_mode')),
              ...
              ListTile(
                ...
                title: Text(langProvider.getText('language_label')),
