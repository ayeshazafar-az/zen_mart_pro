  ...
  Future<void> _rejectUser(
    ...
    final bool? confirm = await showDialog<bool>(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text(
            'Are you sure you want to reject and delete the application for $name? This action cannot be undone.'),
        actions: [
          TextButton(
